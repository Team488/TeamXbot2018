...
public class GripperRotateCounterClockwiseTest extends BaseCompetitionTest{

    GripperRotateCounterClockwiseCommand command;
    ...
    public void setUp() {
        ...
        command = injector.getInstance(GripperRotateCounterClockwiseCommand.class);
