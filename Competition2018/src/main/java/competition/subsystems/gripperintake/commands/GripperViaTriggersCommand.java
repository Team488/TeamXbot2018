...
public class GripperViaTriggersCommand extends BaseCommand {
    ...
    @Override
    public void execute() {
        double ejectPower = MathUtils.squareAndRetainSign(oi.operatorGamepad.getLeftTrigger());
        double intakePower = MathUtils.squareAndRetainSign(-oi.operatorGamepad.getRightTrigger());
