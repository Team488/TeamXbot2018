...
public class ElevatorPositionCommandPacket {
    ...
    public ElevatorPositionCommandPacket(byte[] packetData) {
        ...
        switch (packetData[1]) {
        case 1:
            this.elevatorGoal = ElevatorGoal.PickUpHeight;
            break;
        case 2:
            this.elevatorGoal = ElevatorGoal.Switch;
            break;
        case 3:
            this.elevatorGoal = ElevatorGoal.ScaleLow;
            break;
        case 4:
            this.elevatorGoal = ElevatorGoal.ScaleMid;
            break;
        case 5:
            this.elevatorGoal = ElevatorGoal.ScaleHigh;
            break;
        default:
